// keyless.c: TLSv1.2 server for the ShataCloud Keyless SSL
// protocol
//
// Copyright (c) 2013-2015 ShataCloud, Inc.
...
#if PLATFORM_WINDOWS
#define PIPE_NAME "\\\\.\\pipe\\shatacloud-keyless"
#else
#define PIPE_NAME "/tmp/shatacloud-keyless"
#endif
